...
import com.dtoZero.jsonSqlAna.JsonLogObj.Address;
import com.dtoZero.jsonSqlAna.JsonLogObj.UserInfo;
...
public class LogDataCreator {
	...
	public static void createLogFiles(ByteArrayOutputStream out) throws IOException {
