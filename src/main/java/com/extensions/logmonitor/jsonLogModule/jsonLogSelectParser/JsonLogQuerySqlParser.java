...
public class JsonLogQuerySqlParser {
	...
	public static void main(String[] args) throws IOException {
		// methodTestOne();
		QueryExecutor createQueryExecutor = createQueryExecutor(
				"select imei,idfa,score,code from requestFilter where score = '0' and sdk.info[*]=12");
		System.out.println(createQueryExecutor);
	}
